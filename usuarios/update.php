...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0"><?php echo __('update_employee'); ?></h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form action="../app/controllers/usuarios/update.php" method="post">
                                        <input type="text" name="id_usuario" value="<?php echo $id_usuario_get; ?>"
                                            hidden>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="salario" id="salario" step="0.01"
                                                value="<?php echo $salario; ?>" required><br><br>
                                        </div>

                                        <div class="form-group">
                                            <label for="num_permiso_trabajo"><?php echo __('work_permit'); ?>:</label>
                                            <input type="text" name="num_permiso_trabajo" id="num_permiso_trabajo"
                                                value="<?php echo $num_permiso_trabajo; ?>"><br><br>
                                        </div>

                                        <div class="form-group">
                                            <label for="seguro_medico"><?php echo __('health_insurance'); ?>:</label>
                                            <input type="text" name="seguro_medico" id="seguro_medico"
                                                value="<?php echo $seguro_medico; ?>"><br><br>
                                        </div>

                                        <div class="form-group">
                                            <label for="tipo_empleado"><?php echo __('employee_type'); ?>:</label>
                                            <select name="tipo_empleado" id="tipo_empleado">
                                                <option value="Part-Time" <?php if ($tipo_empleado == 'Part-Time')
                                                    echo 'selected'; ?>>Part-Time</option>
                                                <option value="Full-Time" <?php if ($tipo_empleado == 'Full-Time')
                                                    echo 'selected'; ?>>Full-Time</option>
                                                <option value="Freelance" <?php if ($tipo_empleado == 'Freelance')
