...
<head>
    ...
    <style>
        ...
        .messages-sidebar {
            ...
            z-index: 1001;
            /* Asegura que esté por encima del botón flotante */
            display: flex;
            /* Use flexbox */
        ...
        #messages-list {
            ...
            /* Remove padding */
            flex-grow: 1;
            /* Allow messages-list to take up remaining space */
            overflow-y: auto;
                ...
                <li class="nav-item">
                    <form class="form-inline ml-3">
                        <div class="input-group input-group-sl">
                            <input class="form-control form-control-navbar rounded-pill" type="search"
                                placeholder="<?php echo __('search_placeholder'); ?>" aria-label="Buscar"
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="<?php echo $URL; ?>/app/controllers/language_controller.php?lang=en"
                            class="dropdown-item">
                            English
                        </a>
                        <a href="<?php echo $URL; ?>/app/controllers/language_controller.php?lang=es"
                            class="dropdown-item">
                            Español
                        </a>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="notificationModalLabel"><?php echo __('notifications'); ?></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p><?php echo __('system_updates'); ?><a href="<?php echo $URL; ?>/clientes/index.php"
                                class="btn btn-primary"><?php echo __('go'); ?></a></p>
                        <p><?php echo __('system_updates'); ?></p>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo $URL; ?>/cuentas_por_cobrar" class="nav-link">
                                            ...
                                            <p><?php echo __('accounts_receivable'); ?></p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo $URL; ?>/cuentas_por_pagar" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p><?php echo __('accounts_payable'); ?></p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo $URL; ?>/general" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p><?php echo __('general'); ?></p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo $URL; ?>/pagos" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p><?php echo __('payment_history'); ?></p>
                                        </a>
                                    </li>
                                </ul>
                            </li>
