                                                            ...
                                                            <div style="display: flex">
                                                                <select name="id_categoria" id="" class="form-control" required>
                                                                    ...
                                                                    foreach ($categorias_datos as $categorias_dato){
                                                                        ...
                                                                        <option value="<?php echo $id_categoria; ?>"<?php if($id_categoria == $id_categoria){ ?> selected="selected" <?php } ?> >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo $id_usuario; ?>" disabled>
                                                            <input type="text" name="email" value="<?php echo $id_usuario; ?>" hidden>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="form-group">
