...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header"
                                                        style="background-color: #1d36b6;color: white">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($productos_datos as $productos_dato) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button
                                                                                    class="btn btn-info btn_selecionar_producto">Seleccionar</button>
                                                                                <script>
                                                                            ...
                                                                            <td><?php echo $productos_dato['id_categoria']; ?>
                                                                            </td>
                                                                            <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="usuario_producto"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="descripcion" id="descripcio_producto" cols="30"
                                                            rows="2" class="form-control" disabled></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="stock" id="stock"
                                                            class="form-control" style="background-color: #fff819"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($clients_datos as $clients_dato) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button
                                                                                    class="btn btn-info btn_selecionar_cliente">Seleccionar</button>
                                                                                <script>
                                                                            ...
                                                                            <td><?php echo $clients_dato['telefono_clt']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <img src="<?php echo $URL . "/clientes/image_clt/" . $clients_dato['image_clt']; ?>"
                                                                                    width="50px" alt="asdf">
                                                                            </td>
                                                                            <td><?php echo $clients_dato['mail_clt']; ?>
                                                                            </td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nombre_clt" class="form-control"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="telefono_clt" id="telefono_clt"
                                                            class="form-control" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                value="<?php echo $contador_de_ventas; ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                style="background-color: #fff819;text-align: center"
                                                                id="stock_actual" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="text-align: center"
                                                                id="stock_restante" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <button class="btn btn-primary btn-block"
                                                            id="btn_guardar_venta">Guardar venta</button>
                                                    </div>
                                                </div>
                                                <script>
            ...
            // JavaScript for Product Selection (place inside #modal-buscar_producto .modal-body, AFTER the </tbody>
            tag)
            <script>
            ...
            // Add this script within the

            <head> or at the end of the

            <body> of your create.php file, after jQuery is loaded.
